...
exports.default = {
    ...
    run: function () {
        return __awaiter(this, void 0, void 0, function () {
            var table, api, dynamoDS, code;
            return __generator(this, function (_a) {
                table = new sst.aws.Dynamo(tableName, {
                    fields: { pk: 'string' },
                    primaryIndex: { hashKey: 'pk' },
                });
                api = new sst.aws.AppSync('Api', {
                    schema: 'graphql/schema.graphql',
                    transform: { api: { authenticationType: 'API_KEY' } },
                });
                dynamoDS = api.addDataSource({ name: entity, dynamodb: table.arn });
                code = function (file) { return node_fs_1.default.readFileSync(file, 'utf8'); };
                ...
                return [2 /*return*/, { apiUrl: api.url, tableName: table.name }];
            });
        });
    },
};
