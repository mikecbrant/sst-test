...
(0, vitest_1.describe)('User resolvers', function () {
    ...
    (0, vitest_1.it)('upsert.request builds an UpdateItem request that writes base fields', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(actual.key).toStrictEqual(dynamo.putItem({ key: { pk: 'e-123' }, item: vitest_1.expect.any(Object) })
                        .key);
